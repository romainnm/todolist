...
let projects = JSON.parse(localStorage.getItem(LOCAL_STORAGE_PROJECTS)) || [];

/* Save in LocalStorage*/
function saveProjects() {
  localStorage.setItem(LOCAL_STORAGE_PROJECTS, JSON.stringify(projects));
}
...
let taskId = 0;
let currentTodolist = "";
/* Projects Object  => mock data until the localStorage is*/
/* const projects = [
  {
    name: "Groceries",
    id: "project-" + 0,
...
function projectLinksListener() {
  ...
  projectLinks.forEach((projectLink) => {
    projectLink.addEventListener("click", (e) => {
      tasklistsJs.style.display = "none";
...
function todolistLinksListener() {
  ...
  todolistLinks.forEach((todolistLink) =>
    todolistLink.addEventListener("click", (e) => {
      ...
      tasklistsJs.style.display = "block";
      resetTasklistDisplay();
